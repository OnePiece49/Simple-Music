...
class FSPagerViewLayout: UICollectionViewLayout {
    ...
    internal var leadingSpacing: CGFloat = 10
    ...
    fileprivate var actualInteritemSpacing: CGFloat = 10
    ...
    override open func prepare() {
        ...
        // Size thực tế của item trong CLView
        self.actualItemSize = {
...
//            return pagerView.interitemSpacing
        ...
        // Khoảng cách của item đầu tiên so với leading (lib đang muốn nó nằm giữa)
        self.leadingSpacing = 100//self.scrollDirection == .horizontal ? 0 : (collectionView.frame.width-self.actualItemSize.width)*0.5

        // Khoảng cách từ leading của item trước đến leading của item sau //DEBUG:
        self.itemSpacing = (self.scrollDirection == .horizontal ? self.actualItemSize.width : self.actualItemSize.height) + 20 //self.actualInteritemSpacing
    ...
    override open func targetContentOffset(forProposedContentOffset proposedContentOffset: CGPoint, withScrollingVelocity velocity: CGPoint) -> CGPoint {
        ...
        proposedContentOffset = CGPoint(x: proposedContentOffsetX + 5, y: proposedContentOffsetY)
        return proposedContentOffset
    }
    ...
    internal func contentOffset(for indexPath: IndexPath) -> CGPoint {  //DEBUG:
        ...
        let contentOffsetY: CGFloat = {
            ...
            let contentOffsetY = origin.y - self.leadingSpacing //DEBUG:
