...
protocol ConvertSheetControllerDelegate: AnyObject {
    func didSelectMediaCell(type: ConvertAudioType)
}

class ConvertSheetController: BottomSheetViewCustomController {
    
    //MARK: - Properties
    weak var delegate: ConvertSheetControllerDelegate?
    ...
    deinit {
        print("DEBUG: ConvertSheetController deinit")
    }
...
//MARK: - delegate
extension ConvertSheetController: UITableViewDelegate, UITableViewDataSource {
